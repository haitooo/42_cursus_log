...
const int	ScavTrap::default_hitPoint = 100;
const int	ScavTrap::default_energyPoint = 50;
const int	ScavTrap::default_attackDamage = 20;

ScavTrap::ScavTrap(const std::string &newname) : ClapTrap(newname, default_hitPoint, default_energyPoint, default_attackDamage)
{
	std::cout << BLUE
